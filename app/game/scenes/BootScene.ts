...
export class BootScene extends Phaser.Scene {
  ...
  preload(): void {
    ...
    ["shinobu", "kiyohara", "voice_grunt1", "voice_grunt2", "voice_grunt3", "voice_grunt4",
     "ishii", "shiori", "kishishita", "hijiri", "luna"].forEach(who => {
      ["down", "up", "left", "right"].forEach(dir => {
